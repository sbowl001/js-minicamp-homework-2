...
function averageTestScore(testScores) {
 ...
 for ( var i= 0; i < testScores.length; i ++ ){
  ...
  } return avg; // testScores is an array.  Iterate over testScores and compute the average.
  // return the average
}

function largestNumber(numbers) {
  return Math.max.apply(Math ,numbers);// numbers is an array of integers
